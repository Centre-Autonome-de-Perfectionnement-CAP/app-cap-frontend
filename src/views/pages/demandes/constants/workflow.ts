...
export const STATUS_COLORS: Record<string, { color: string; bg: string; text: string }> = {
  ...
  // Onglet synthétique : dossiers en circuit actif chez un acteur (status ≠ secretaire_correction)
...
// - secretaire_correction, circuit_correction et flagged sont urgent=true : pulse quand count > 0
